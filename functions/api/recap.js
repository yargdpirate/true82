...
const NICKNAME_RULES = `nickname — the star of the whole page, and it should be WEIRD. Go wacky, absurd, oddly specific, and gleefully chaotic: the kind of strange, inexplicable group name a locker room actually gives itself, in the spirit of Banana Boat or the Hamptons crew. Think "The Alligator Boys" or "The Time Stoppers," not a trophy. Reach for the mundane-made-mythic, dumb-genius non sequiturs, unexpected animals, oddball jobs, snack foods, swamp creatures, cryptids, small-town-legend energy: anything that makes a player laugh and open the app just to see what it dreams up next. Different every single time; never reuse a shape you'd hand another roster.
BANNED REGISTER (this is the "yuck" zone): do NOT reach for the epic, mythic, "great team" vibe. No Makers, Legends, Titans, Gods, Kings, Dynasty, Empire, Immortals, or Reign, and no other noble, elite, or ominous abstraction (e.g. "Myth Makers", "The Undertakers"). If it sounds like a compliment or a movie trailer, throw it out. We want a name that sounds like an inside joke nobody outside the room understands.
Anchor it to ONE sideways detail about this team (a player's game, a defensive identity, a play style, an era, a vibe): loosely enough to stay strange, tightly enough that a columnist could later bluff a straight-faced explanation. Lead with chaos, not description. Keep it good-natured: playful and bizarre, never crude or mean.
Format: 2 to 4 words, Title Case, and PLURAL so it fits "<NICKNAME> FINISH <record>" (e.g. "The Alligator Boys Finish 74-8"); may begin with "The".
...
article — 4 sentences, 75 to 100 words, pure narrative: no analysis, no weaknesses, no future outlook, no questions. Open by explaining how the team earned its nickname and commit to it fully: give the origin as plain fact, either something the group did off the court or the way it captures their style of play, and never hedge, wink at, or apologize for the name. A natural opener is "Nicknamed ... because ...", filled in with the actual nickname. Name two to four players by surname and narrate what they actually did on the floor, not what kind of team they were. Match the season tier and tone directive provided. Close on one concrete image from the season. Never mention ratings, models, engines, fantasy, video games, or drafting, and invent nothing beyond the nickname's origin story: no injuries, trades, or quotes. Do not use em dashes.`;
