...
(function (root, factory) {
  ...
  var ROLES = [
    ["surfaces"],
    ["ground", "#101418", "the page"],
    ["ground-2", "#1A2027", "panels and cards"],
    ["ground-3", "#232B34", "wells, hovers, pressed rows"],
    ["overlay", "#06080B", "scrims behind sheets and overlays"],
    ["paper", "#F4ECDD", "light paper (the Tribune's newsprint)"],
    ["paper-2", "#E4D9C2", "darker paper"],
    ["lines"],
    ["line", "#232B34", "hairlines and borders on the ground"],
    ["rule", "#6E5530", "bronze rules: the header, tickets, fields"],
    ["line-paper", "#232A4E", "hairlines on paper"],
    ["text"],
    ["text", "#E8E4D8", "primary text"],
    ["text-2", "#9AA0A6", "secondary text"],
    ["label", "#B98A4F", "small caps labels and eyebrows"],
    ["ink", "#232A4E", "text on paper"],
    ["ink-2", "#5B5E73", "secondary text on paper"],
    ["brand and action"],
    ["accent", "#FFB52E", "the main action and the brand"],
    ["accent-hi", "#FCEEBB", "the accent's pale highlight"],
    ["accent-edge", "#9E5A0F", "keycap edge under an accent face"],
    ["accent-ink", "#2A1A05", "text printed on an accent face"],
    ["metal", "#B98A4F", "bronze ornament: frames, pips, rails"],
    ...
    ["sun-edge", "#C7870A", "keycap edge under a sun face"],
    ["sun-ink", "#8A5D00", "deep sun text"],
    ["the game"],
    ["win", "#FFB511", "a win: reel coins, the season strip"],
    ["loss", "#F55A41", "a loss: reel rings, the season strip"],
    ["the season print (results-riso.js, reel-riso.js)"],
    ["print-paper", "#1A2027", "the stock the season prints on (dark: the inks glow, like screen print on black card)"],
    ["print-key", "#0078BF", "the key ink: sky, water, ticks, month labels"],
    ["print-pop", "#FF48B0", "the second ink: offsets, ridges, rims"],
    ["print-sun", "#FFB511", "the light of a winning season"],
    ["print-dusk", "#FF6C2F", "the light of a middling season"],
    ["print-night", "#00838A", "the light of a losing season"],
    ["neutral effects"],
  ...
  var FONTS = [
    ["disp", "\"Barlow Condensed\", \"Arial Narrow\", sans-serif", "display: numbers, titles, buttons"],
    ["body", "\"Barlow\", system-ui, sans-serif", "running text"],
    ["mono", "\"IBM Plex Mono\", ui-monospace, monospace", "data, labels, eyebrows"],
    ["serif", "Georgia, \"Times New Roman\", serif", "the Tribune only (retiring)"]
  ];
  var SHAPE = [
    ["r-btn", "9px", "button corners"],
    ["r-card", "0px", "card corners (sheets round their top by twice this, at least 14px)"],
    ["r-chip", "7px", "chip and tag corners"],
