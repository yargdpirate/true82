...
INSERT OR IGNORE INTO traits_v1 (id, display_name, short_definition, category, definition_version, status, created_at, updated_at) VALUES
  ...
  ('team-defender',             'Team Defender',             'Makes the whole defense work: rotations, communication, help in the right place on time.',           'defense',  1, 'core', CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ('switchable-defender',       'Switchable Defender',       'Can take the switch and hold up, guard to big, without the defense breaking.',                       'defense',  1, 'core', CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ('playmaker',                 'Playmaker',                 'Creates advantages for teammates: the defense is worse off after he touches the ball.',              'creation', 1, 'core', CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ('rim-pressurer',             'Rim Pressurer',             'Gets to the rim, again and again; the paint is where his offense lives.',                            'creation', 1, 'core', CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
...
INSERT OR IGNORE INTO trait_questions_v1 (id, trait_id, player_name, season, season_label, status, editorial_priority, definition_version, created_at, updated_at) VALUES
  ...
  ('marcus-smart-2019-iso-defender',            'iso-defender',       'Marcus Smart',       2019, '2018-19', 'active',  88, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ('carmelo-anthony-2013-iso-defender',         'iso-defender',       'Carmelo Anthony',    2013, '2012-13', 'active',  86, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ...
  ('bam-adebayo-2022-team-defender',            'team-defender',      'Bam Adebayo',        2022, '2021-22', 'active',  88, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ('al-horford-2018-team-defender',             'team-defender',      'Al Horford',         2018, '2017-18', 'active',  86, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ...
  ('kevin-durant-2017-switchable-defender',     'switchable-defender','Kevin Durant',       2017, '2016-17', 'active',  88, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ...
  ('russell-westbrook-2017-playmaker',          'playmaker',          'Russell Westbrook',  2017, '2016-17', 'active',  89, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ('domantas-sabonis-2023-playmaker',           'playmaker',          'Domantas Sabonis',   2023, '2022-23', 'active',  87, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ...
  ('damian-lillard-2020-super-three-point-shooter','super-three-point-shooter', 'Damian Lillard',  2020, '2019-20', 'active',  89, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ('ray-allen-2006-super-three-point-shooter',     'super-three-point-shooter', 'Ray Allen',       2006, '2005-06', 'active',  87, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ...
  ('kevin-durant-2017-clutch',                  'clutch',             'Kevin Durant',       2017, '2016-17', 'active',  90, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ('joel-embiid-2023-clutch',                   'clutch',             'Joel Embiid',        2023, '2022-23', 'active',  88, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ...
  ('russell-westbrook-2017-rim-pressurer',      'rim-pressurer',      'Russell Westbrook',  2017, '2016-17', 'active',  88, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ...
  ('khris-middleton-2021-off-ball-scorer',      'off-ball-scorer',    'Khris Middleton',    2021, '2020-21', 'active',  87, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ...
  ('kobe-bryant-2006-tough-shot-maker',         'tough-shot-maker',   'Kobe Bryant',        2006, '2005-06', 'active',  90, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ('kyrie-irving-2016-tough-shot-maker',        'tough-shot-maker',   'Kyrie Irving',       2016, '2015-16', 'active',  88, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ('carmelo-anthony-2013-tough-shot-maker',     'tough-shot-maker',   'Carmelo Anthony',    2013, '2012-13', 'active',  87, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ('jimmy-butler-2020-tough-shot-maker',        'tough-shot-maker',   'Jimmy Butler',       2020, '2019-20', 'active',  86, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000),
  ('devin-booker-2021-tough-shot-maker',        'tough-shot-maker',   'Devin Booker',       2021, '2020-21', 'active',  85, 1, CAST(strftime('%s','now') AS INTEGER) * 1000, CAST(strftime('%s','now') AS INTEGER) * 1000);
