...
if (!jsonPath || !cssPath) { console.error("usage: node ship-look.js <export.json> <export.css>"); process.exit(1); }
...
const head = "/* ==== LOOK: generated by docs/reprint-lab/src/ship-look.js from the Reprint Lab. Do not edit by hand. ====\n" +
  ...
  "   change it in the lab and ship it again. " + after + " color-mix() uses remain (older phones skip them). ==== */\n";
