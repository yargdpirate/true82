...
(function () {
  window.LAB.presets = (window.LAB.presets || []).concat([
    { id: "team-nights-vice", name: "Heat Vice", line: "Neon script over a South Beach sunset.",
      note: "Pink and aqua on midnight, like the Vice jerseys: a script over a neon grid, a ball rising through the net. Look at the glowing buttons and the solid pink tags.",
      rc: { palette: "vice", ground: "night", layout: "inline", font: "yellowtail", font82: "bigshoulders", ink82: "a",
